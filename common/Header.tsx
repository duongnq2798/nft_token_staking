...
import { AccountConnect } from 'utils/namespaces-components'
      ...
      <div className={`flex h-20 justify-between px-5 text-white`}>
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex cursor-pointer text-xl font-semibold text-white hover:text-gray-400" rel="noreferrer"
          >
